...
//import static com.android.DriftSys.ComService.TAG;
...
/*        mForgetListener = new WifiManager.ActionListener() {
    ...
    public void openWifi() {
        if (!mWifiManager.isWifiEnabled()) {
            ...
            Log.e("wifiAdmin", "setWifiEnabled");
...
*/
    ...
    public boolean forgetConfig(String ssid) {
		int netId;
		netId = IsConfiguration(ssid);
		Log.i("zhiwei", "forgetConfig netId = " + netId);
		if (netId != -1) {
			Log.i("zhiwei", "forgetConfig WifiManager.forget");
    ...
    private WifiConfiguration createWifiInfo(String SSID, String Password, WifiCipherType Type) {
        ...
        //    Log.e(TAG,"ssss ssss ssss WIFICIPHER_NOPASS");
            config.wepKeys[0] = "\"\"";
            config.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
            config.wepTxKeyIndex = 0;
        }
